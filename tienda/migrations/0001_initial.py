...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=100, verbose_name='Nombre del Fardo')),
                ('descripcion', models.TextField(verbose_name='Descripción')),
                ('calidad', models.CharField(choices=[('PREMIUM', 'Premium'), ('PRIMERA', 'Primera Selección'), ('SEGUNDA', 'Segunda Selección')], default='PRIMERA', max_length=20)),
                ('peso_kg', models.DecimalField(decimal_places=2, default=45.0, max_digits=5, verbose_name='Peso Kg')),
